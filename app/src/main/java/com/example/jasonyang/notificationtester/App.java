...
public class App extends Application {
    ...
    public void onCreate() {
        ...
        createNotificationChannels();           //this creates the notification channels
    }

    private void createNotificationChannels(){
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){                             //this checks if the OS is OREO and above
